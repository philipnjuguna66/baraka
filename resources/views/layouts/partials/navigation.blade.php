...
<div class="bg-primary-950 text-white mt-0 pt-0 sticky top-0 left-0 right-0 z-50" x-data="{ open: false }">
            ...
            {{--<div class="hidden ">
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://web.facebook.com/fanakarealestate" target="_blank">Facebook</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://twitter.com/@FanakaLtd" target="_blank">Twitter</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href="https://www.instagram.com/fanakarealestate/" target="_blank">Instagram</a>
                    </div>
                ...
                <div class="text-white">
                    <div class="flex flex-row gap-4">
                        ...
                        <a href=" https://www.youtube.com/@FanakaRealEstateLtd" target="_blank">Youtube</a>
                    </div>
    ...
    <nav class="py-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-md shadow-primary-950/50  ">
